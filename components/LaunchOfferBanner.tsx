            ...
            <div className="relative p-4 sm:p-6">
              ...
              <p className="max-w-2xl text-xs font-light leading-relaxed text-brand-brown/70 sm:text-sm">
                {hasClaimed
                  ...
                  : "Choose exactly 2 different products, keep quantity 1 each, and place a ₹0 launch order. Share the receipt on Instagram Story and tag @annvriksh for verification."}{" "}
              </p>
                  ...
                  <div className="mt-4 grid grid-cols-3 gap-2 sm:gap-3">
                    {[
                      ...
                      },
                      {
                        icon: Camera,
                        title: "Story Tag",
                        body: "Upload receipt and tag @annvriksh.",
                      },
                    ].map((item) => (
                      <div
                        key={item.title}
