              ...
              <div className="flex-1">
                <p className="text-xs text-brand-brown/40 font-light leading-relaxed text-balance">
                  {launchOffer.isEligible
                    ...
                    : "Pick exactly 2 different products, 1 quantity each. Place your order, upload the final order confirmation to your Instagram Story, and tag @urban_kisan for verification."}
                </p>
              </div>
