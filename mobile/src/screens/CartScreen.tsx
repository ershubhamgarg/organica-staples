      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.header}>
          ...
          {items.length > 0 && (
            ...
            >
              <Trash2 color={colors.danger} size={14} opacity={0.4} />
              <AppText
                variant="small"
                style={{
                  color: colors.danger,
        ...
        {items.length === 0 ? (
          <Card style={styles.empty}>
            ...
            <AppText variant="small">
              Add organic staples to begin your order.
            </AppText>
          </Card>
        ) : (
          <>
              ...
              <Card key={item.id} style={styles.item}>
                ...
                <View style={styles.itemBody}>
                  ...
                  <QuantityStepper
                    value={item.quantity}
                    onChange={(quantity) =>
                      updateQuantity(item.id, quantity, user?.id)
                    }
                  />
                </View>
                <View style={styles.itemRight}>
                  <Trash2
                    color={colors.danger}
                    size={18}
                    onPress={() => removeFromCart(item.id, user?.id)}
                  />
            ...
            <Card style={styles.summary}>
              ...
              <Row
                label="Shipping"
                value={
                  totals.shipping ? `₹${totals.shipping.toFixed(2)}` : "Free"
                }
              />
